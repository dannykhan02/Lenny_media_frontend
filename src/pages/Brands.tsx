...
const Brands = () => {
  return (
    <div className="bg-stone-50 min-h-screen font-sans">
      {/* Hero */}
      <div className="bg-stone-900 pt-32 pb-24 px-4 text-center relative overflow-hidden">
        {/* Background elements */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto animate-[fadeIn_0.8s_ease-out]">
             <span className="text-gold-500 font-bold tracking-widest uppercase text-sm mb-4 block">Our Ecosystem</span>
             <h1 className="font-serif text-5xl md:text-7xl font-bold text-white mb-6">The Collective</h1>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col md:flex-row gap-16 items-center">
                <div className="w-full md:w-1/2">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-stone-900 rounded-full text-gold-500 font-bold text-sm mb-6 animate-[fadeInLeft_0.5s_ease-out]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
                        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm border border-stone-100">
                            <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-gold-600"><Target className="w-5 h-5"/></div>
                            <span className="font-bold text-stone-800">Brand Strategy</span>
                        </div>
                        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm border border-stone-100">
                             <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-gold-600"><Share2 className="w-5 h-5"/></div>
                            <span className="font-bold text-stone-800">Social Media Mgmt</span>
                        </div>
                        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm border border-stone-100">
                             <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-gold-600"><PenTool className="w-5 h-5"/></div>
                            <span className="font-bold text-stone-800">Content Creation</span>
                        </div>
                        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm border border-stone-100">
                             <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-gold-600"><BarChart className="w-5 h-5"/></div>
                            <span className="font-bold text-stone-800">Digital Advertising</span>
                        </div>
                    </div>

                    <Link to="/contact" className="inline-flex items-center gap-3 px-8 py-4 bg-stone-900 text-white rounded-full font-bold hover:bg-gold-500 hover:text-stone-900 transition-all shadow-lg">
                ...
                <div className="w-full md:w-1/2 relative group">
                    ...
                    <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden border border-stone-100 p-8 md:p-12 transition-transform duration-500 group-hover:-translate-y-2">
                         <div className="grid grid-cols-2 gap-4">
                            <div className="bg-stone-50 p-6 rounded-2xl text-center hover:bg-stone-100 transition-colors">
                                <Globe className="w-8 h-8 text-stone-900 mx-auto mb-3" />
                                <h4 className="font-bold text-stone-900">Digital</h4>
                            </div>
                            <div className="bg-stone-900 p-6 rounded-2xl text-center text-white hover:bg-stone-800 transition-colors">
      ...
      <div className="py-24 px-4 bg-white border-t border-stone-100">
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
                <div className="w-full md:w-1/2">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold-100 rounded-full text-gold-700 font-bold text-sm mb-6">
                    ...
                    <Link to="/services" className="inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-stone-900 text-stone-900 rounded-full font-bold hover:bg-stone-900 hover:text-white transition-all shadow-md">
      ...
      {/* Call to Action */}
       <div className="bg-stone-900 py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold text-white mb-6">One Team. Infinite Possibilities.</h2>
