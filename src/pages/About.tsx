...
const About: React.FC = () => {
  return (
    <div className="bg-white min-h-screen font-sans">
      {/* Hero Section */}
      <div className="relative bg-stone-900 py-32 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center z-10">
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-white mb-8">About Lenny Media</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                <div className="flex items-center gap-2 mb-4">
                     ...
                     <span className="text-stone-500 font-medium uppercase tracking-wide text-sm">Juja Square, 1st Floor</span>
                </div>
                <h2 className="font-serif text-4xl md:text-5xl font-bold text-stone-900 mb-6">Who We Are</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1">
                    ...
                    <h3 className="font-serif text-3xl font-bold text-stone-900 mb-4">Corporate & Commercial</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <h3 className="font-serif text-3xl font-bold text-stone-900 mb-4">Weddings & Social Events</h3>
                    <p className="text-stone-600 text-lg leading-relaxed mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1">
                    ...
                    <h3 className="font-serif text-3xl font-bold text-stone-900 mb-4">Studio, Portraits & Lifestyle</h3>
                    <p className="text-stone-600 text-lg leading-relaxed mb-4">
      ...
      {/* Mission & Values */}
      <div className="py-24 px-4 relative overflow-hidden bg-white">
         <div className="max-w-4xl mx-auto text-center relative z-10">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-stone-900 mb-8">Our Philosophy</h2>
      ...
      <div className="bg-stone-900 py-24 px-4 text-center">
          <div className="max-w-4xl mx-auto">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold text-white mb-6">Tell Your Story Beautifully</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/contact" className="border border-stone-700 text-white px-10 py-4 rounded-full font-bold hover:bg-stone-800 transition-all duration-300">
                    Visit Our Studio
                </Link>
              </div>
          </div>
