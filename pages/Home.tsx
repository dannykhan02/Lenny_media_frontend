  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-4 max-w-5xl mx-auto">
        ...
        <FadeIn delay="500ms">
            <p className="text-stone-300 text-xl md:text-2xl font-light max-w-2xl mx-auto mb-12 leading-relaxed">
        ...
        <FadeIn delay="700ms">
            <div className="flex flex-col md:flex-row gap-6">
                <Link 
                    to="/portfolio" 
                    className="group relative px-8 py-4 bg-white text-stone-900 font-bold rounded-full overflow-hidden hover:scale-105 transition-transform duration-300"
                >
                    <span className="relative z-10 group-hover:text-gold-600 transition-colors">View Portfolio</span>
                </Link>
                <Link 
                    to="/booking" 
                    className="group px-8 py-4 bg-transparent border border-white/30 text-white font-bold rounded-full hover:bg-white/10 hover:border-white transition-all duration-300 backdrop-blur-sm"
                >
                    Book a Session
                </Link>
            </div>
...
const Marquee = () => {
  return (
    <div className="bg-stone-900 py-6 overflow-hidden whitespace-nowrap border-y border-stone-800">
      <div className="inline-block animate-[marquee_20s_linear_infinite]">
        {[1, 2, 3, 4, 5, 6].map((i) => (
            <span key={i} className="text-stone-500 font-serif text-2xl mx-12 italic opacity-50 hover:opacity-100 hover:text-gold-500 transition-colors cursor-default">
...
const AboutSection = () => {
    return (
        <section className="py-24 md:py-32 bg-stone-50 px-4 overflow-hidden">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <FadeIn delay="0ms">
                        <div className="grid grid-cols-2 gap-4 md:gap-6">
                          ...
                          <div className="flex flex-col gap-4 md:gap-6 pt-0 md:pt-12">
                            ...
                            />
                            <div className="bg-stone-900 p-6 rounded-2xl text-white shadow-xl flex flex-col justify-center h-full transform hover:bg-stone-800 transition-colors">
                ...
                <div className="relative z-10">
                    <FadeIn delay="200ms">
                        ...
                        <h2 className="font-serif text-5xl md:text-6xl font-bold text-stone-900 mb-8 leading-tight">
                    ...
                    <FadeIn delay="600ms">
                        <div className="grid grid-cols-2 gap-8 mb-10 border-t border-stone-200 pt-8">
                            <div>
                                <h3 className="text-4xl font-bold text-stone-900 mb-1">Juja</h3>
                                <p className="text-stone-500 text-sm uppercase tracking-wide">Headquarters</p>
                            </div>
                            <div>
                                <h3 className="text-4xl font-bold text-stone-900 mb-1">47+</h3>
                                <p className="text-stone-500 text-sm uppercase tracking-wide">Counties Covered</p>
                            </div>
                        </div>
                        
                        <div className="flex gap-4">
                            <Link to="/about" className="inline-flex items-center gap-2 font-bold text-stone-900 border-b-2 border-stone-900 pb-1 hover:text-gold-600 hover:border-gold-600 transition-all">
                                Read Our Story <ArrowRight className="w-4 h-4" />
                            </Link>
                             <Link to="/booking" className="inline-flex items-center gap-2 font-bold text-gold-600 border-b-2 border-gold-600 pb-1 hover:text-stone-900 hover:border-stone-900 transition-all">
    ...
    return (
        <section className="py-24 bg-white px-4">
            <div className="max-w-7xl mx-auto mb-16 text-center">
                 <FadeIn>
                    <h2 className="font-serif text-4xl md:text-5xl font-bold text-stone-900 mb-4">Our Expertise</h2>
                    <p className="text-stone-500 max-w-xl mx-auto">Comprehensive visual solutions tailored to your unique needs.</p>
                 </FadeIn>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                {services.map((service, idx) => (
                    <FadeIn key={idx} delay={`${idx * 200}ms`}>
                        <div className="group relative rounded-2xl overflow-hidden bg-stone-100 hover:shadow-2xl transition-all duration-500 h-[450px]">
                            ...
                            <div className="relative z-10 p-10 h-full flex flex-col justify-between">
                                <div>
                                    ...
                                    <h3 className="font-serif text-3xl font-bold text-stone-900 mb-4">{service.title}</h3>
                                    <p className="text-stone-600 leading-relaxed group-hover:text-stone-900 font-medium transition-colors">
                                        {service.description}
                                    </p>
                                </div>
                                <div className="transform translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                                    <Link to="/services" className="inline-flex items-center gap-2 font-bold text-stone-900 hover:text-gold-600">
        ...
        <section className="py-24 bg-stone-900 text-white px-4">
             <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row justify-between items-end gap-6">
                 <FadeIn>
                    ...
                    <p className="text-stone-400">A curated showcase of our recent projects.</p>
                 </FadeIn>
                 <FadeIn delay="200ms">
                     <Link to="/portfolio" className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 rounded-full hover:bg-white hover:text-stone-900 transition-all">
...
const FinalCTA = () => {
    return (
        <section className="relative py-32 bg-white px-4 overflow-hidden">
             {/* Reliable subtle background texture */}
             <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2000&auto=format&fit=crop')] opacity-5 bg-cover bg-center"></div>
             {/* Gradient Blob */}
             ...
             <div className="max-w-4xl mx-auto text-center relative z-10">
                <FadeIn>
                    <h2 className="font-serif text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link to="/booking" className="px-10 py-5 bg-stone-900 text-white font-bold text-lg rounded-full shadow-2xl hover:bg-gold-500 hover:text-stone-900 hover:scale-105 transition-all duration-300">
                            Book Your Session
                        </Link>
                        <Link to="/quote" className="px-10 py-5 bg-white text-stone-900 border-2 border-stone-200 font-bold text-lg rounded-full hover:border-stone-900 transition-all duration-300">
                            Get a Quote
                        </Link>
                    </div>
                </FadeIn>
